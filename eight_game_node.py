...
class EightGameNode:
    ...
    def move_left(self):
        ...
        empty_posision = EightGameNode.get_empty(self.board)
        row, col = empty_posision["row"], empty_posision["col"]
        ...
        if col > 0:
            ...
            return EightGameNode(new_board)
